   ...
   public class DbIntializer
    {
        ...
        public async Task seed()
        {
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                ...
                {
                    new ProductCategory() { Name="Men shirt",PerentId = null,SeoAlias="men-shirt",Status=Status.Active,SortOrder=1,
                    ...
                    new ProductCategory() { Name="Women shirt",SeoAlias="women-shirt",PerentId = null,Status=Status.Active ,SortOrder=2,
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Men shoes",SeoAlias="men-shoes",PerentId = null,Status=Status.Active ,SortOrder=3,
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Woment shoes",SeoAlias="women-shoes",PerentId = null,Status=Status.Active,SortOrder=4,
                        Products = new List<Product>()
                        {
